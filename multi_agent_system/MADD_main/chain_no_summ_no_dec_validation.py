...
from additional_agents_for_exps import ConductorDecSummarizerAgent
from memory import ChatMemory
from prompting.props import props_descp_dict
from testcase.validate_pipeline import (
    add_answers, validate_conductor)
...
class ValidationChain:
    ...
    def __init__(
        ...
        self.conductor_agent = ConductorDecSummarizerAgent(
            ...
            if not (tool):
                ...
                if isinstance(tool, list):
                    ...
                    for t in tool:
                        ...
                        if total_attempt > self.attempt:
                            ...
                            try:
                                is_valid = validate_conductor(
                                    TOTAL_QUERYS, "make_answer_chat_model", sub_task_number, self.validation_path
                                )
                            except Exception as e:
                                print("VALIDATION ERROR: ", e)
                            sub_task_number +=1
                            free_response_store.append(self.chat_agent.call(
                        ...
                        if t['name'] == "make_answer_chat_model":
                    ...
                    finally_answer = self.conductor_agent.call(self.chat_history.store)
                    
                    self.chat_history.store = []
                    return free_response_store, tables_store, finally_answer 
                else:
                    self.chat_history.store = []
    ...
    def run(self, human_message: str) -> str:
        ...
        free_response_store, tables_store, finally_ans = self.task_handler(0)
...
if __name__ == "__main__":
    ...
    for i, q in enumerate(questions):
        ...
        add_answers(
            [answers_store, tables_store, total_success], "./answers_no_decomposer_no_sum_4.xlsx"
        )
