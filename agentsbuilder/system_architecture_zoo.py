...
from agents import DecomposeAgent, RAGAgent
...
from agentsbuilder.prompting.prompting_two_agents import (
...
class TwinsChain:
    ...
    def run_chain(self, user_msg: str):
        ...
        for n, task in enumerate(tasks):
            ...
            #     continue
            try:
                answer = self.conductor.invoke({"input": task})
    ...
    def run_chain(self, user_msg: str):
        ...
        for n, task in enumerate(tasks):
            ...
            try:
                ...
                answer = self.conductor.invoke({"input": full_question})
